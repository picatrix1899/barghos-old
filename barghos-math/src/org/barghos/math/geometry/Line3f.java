...
public class Line3f
{
	...
	public Line3f(ITup3fR p1, ITup3fR p2)
	{
		assert(p1 != null);
		assert(p2 != null);
		set(p1, p2);
	...
	public Line3f(ITup3fR p1, double x2, double y2, double z2)
	{
		assert(p1 != null);
		set(p1, x2, y2, z2);
	}
	
	public Line3f(double x1, double y1, double z1, ITup3fR p2)
	{
		assert(p2 != null);
		set(x1, y1, z1, p2);
	}
	...
	public Line3f set(ITup3fR p1, ITup3fR p2)
	{
		assert(p1 != null);
		assert(p2 != null);
	...
	public Line3f set(ITup3fR p1, double x2, double y2, double z2)
	{
		assert(p1 != null);
		return setP1(p1).setP2(x2, y2, z2);
	}
	
	public Line3f set(double x1, double y1, double z1, ITup3fR p2)
	{
		assert(p2 != null);
