...
{
	private static final IPool<LDRColor4> pool = new DequePool<LDRColor4>(LDRColor4.class);
	 ...
	 * @return A stored instance.
	 */
	public static LDRColor4 get(ITup4R t) { assert(t != null); return pool.get().set(t); }
